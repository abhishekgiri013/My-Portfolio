    ...
    <main className=" w-screen h-screen relative">
      <div className="flex items-center w-full h-full bg-cover bg-center " style={{ backgroundImage: "url(/main-bg.webp)" }}>
        <div className=" pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className=" text-gray-200 hidden md:block">Lorem ipsum dolor sit amet consectetur adipisicing elit.
          </p>
      ...
      <div className=" absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5">
        ...
        <Link href="/contact-me" className=" rounded-[20px] group border bg-transparent border-white px-5 py-3 text-lg text-white max-w-[200px]">
